...
class TestParseSshareOutput:
    ...
    def test_separates_user_and_account_entries(self) -> None:
        ...
        entries = [
            ...
            ("physics", "alice", "50", "0.125", "500", "0.075", "0.15", "0.85"),
        ...
        # Check user entry
        assert user_priorities[0]["User"] == "alice"
...
class TestParseSprioOutput:
    ...
    def test_sorts_by_priority_descending(self) -> None:
        ...
        entries = [
            ("12345", "alice", "physics", "1000", "100", "800", "200", "300", "100"),
            ("12346", "bob", "chemistry", "1500", "80", "600", "150", "270", "100"),
            ("12347", "charlie", "biology", "1200", "90", "700", "180", "280", "100"),
        ]
